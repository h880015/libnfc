...
IF(NOT LIBUSB_FOUND)
  IF(WIN32)
    IF(MINGW)
      ...
      SET(OLD_LIB_SUFF ${CMAKE_FIND_LIBRARY_SUFFIXES})
      SET(CMAKE_FIND_LIBRARY_SUFFIXES "${CMAKE_FIND_LIBRARY_SUFFIXES};.dll")
      FIND_LIBRARY(LIBUSB_LIBRARIES NAMES libusb0 PATHS "${CMAKE_CURRENT_BINARY_DIR}/LibUSB-Win32/bin/amd64")
      SET(LIBUSB_LIBRARY_DIR "${CMAKE_CURRENT_BINARY_DIR}/LibUSB-Win32/bin/amd64")
      SET(CMAKE_FIND_LIBRARY_SUFFIXES ${OLD_LIB_SUFF})
    ELSE(MINGW)
